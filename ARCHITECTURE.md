...
Run it standalone (after a fresh `astro build`) to iterate on the look without regenerating documents: `npm run og:generate -- --theme=nordic --wallpaper=docs/repo-assets/bkg-samples/wavelines_example.png`. Full CLI reference and CI wiring — `docs/INFO_en.md` §12.
